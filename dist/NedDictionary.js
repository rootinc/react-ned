...
var NedDictionary = function NedDictionary(properties) {
  ...
  this.setLanguage = function (lang) {
    ...
    (0, _jquery2.default)("*").trigger("language-changed");
  };

  this.getHTML = function (lang, textId) {
    return _this.data[lang].find(function (item) {
      return item.id === textId;
    }).text;
  };

  this.getText = function (lang, textId) {
    var html = _this.getHTML(lang, textId);
  ...
  this.fetchAll = function (urls) {
    _this.count = 0;
    _this.total = Object.keys(urls).length;

    for (var lang in urls) {
      _this.fetchData(lang, urls[lang]);
    }
  };
  ...
  this.fetchData = function (lang, url) {
    ...
    _jquery2.default.ajax({
      ...
      if (that.count === that.total) {
        (0, _jquery2.default)("*").trigger("ned-loaded");
        that.ready = true;
      }
    }).fail(function (err) {
      console.log(err);
